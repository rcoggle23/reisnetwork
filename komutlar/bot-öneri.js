...
.setColor(AloneDogru)
.setTitle("Reis Network | Başarılı")
...
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`);  
  ...
  if (!öneri) {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .setAuthor("<a:yan:1096417554710417518> Yeni Bir Öneri!", client.user.avatarURL())
 
      .addField("<a:yan:1096417554710417518> • Öneren Kullanıcı:", message.author.tag, true)
 
      .addField("<a:yan:1096417554710417518> • Öneren Kullanıcı ID:", message.author.id,true)
 
      .addField("<a:yan:1096417554710417518> • Önerisi:", öneri)
