...
.setDescription(`<a:yan:1096417554710417518>  **| Oynatılan bir müziği geçebilmek için bir ses kanalında olmanız gerekmektedir!**`)
...
.setColor(AloneDogru) 
.setTitle("Reis Network | Atla")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:yan:1096417554710417518>  **|** \`${sarki.name}\` **adlı müzik** ${message.author} **tarafından geçildi!**`) 
